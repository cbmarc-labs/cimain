...
$login = array('id'=>'login', 'name'=>'login', 'value'=>$user['login'],
		'autofocus'=>'autofocus');
...
<div class="row">
	<div class="span3">
		...
		<div class="control-group <?=$error?>">
			...
			<div class="controls">
				<?=form_dropdown('sex', $sex, $user['sex'], 'id="sex" class="removefirstelement"')?>
			</div>
		</div>
	</div>
	<div class="span3">
		<div class="control-group">
			...
			<div class="controls">
				<?=form_dropdown('color[]', $color, $user['color'], 'id="color" multiple="multiple"')?>
			</div>
		</div>
	</div>
</div>
